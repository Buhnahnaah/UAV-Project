...
void intro(){
  ...
  delay(1500);
  Serial.println(F(""));
  Serial.println(F("DIY"));
  delay(500);
  Serial.println(F("Your"));
  delay(500);
  Serial.println(F("UAV"));
  delay(500);
  Serial.println(F("Controller"));
  delay(1000);
  Serial.println(F(""));
  Serial.println(F("UAV Setup Program"));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  delay(1500);
  Serial.println(F("For questions: https://github.com/Buhnahnaah/UAV-Project"));
  Serial.println(F(""));
